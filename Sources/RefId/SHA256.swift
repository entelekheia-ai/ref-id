...
//
// SHA-256 in plain Swift (FIPS 180-4), so the package depends on no platform crypto framework.
// Proven by the digest vectors and by the specification's own sidecar.
