...
`relate(a, b)` reports the full per-dimension relation the other three reduce from, and `verdict(a, b)`
reads it once location qualifiers are hints — an identity axis, a content axis and what decided each. `canonical_identifier`
