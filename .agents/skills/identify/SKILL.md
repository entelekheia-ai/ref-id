...
composition a package declares by name, is a node. A relation between two nodes is an edge. The
conditions a reading was taken under are attributes. Neither an edge nor an attribute gets an identifier,
